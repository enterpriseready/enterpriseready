...
{{< note >}}
*This might appear to be a self-serving feature for us to focus on, we debated if we should even list it. However, since we thought it was important enough to build <a href="https://www.replicated.com" onClick="ga('send', 'event', 'Button', 'Click', 'Replicated - Deployment Options');>an entire company around</a>, we decided it was important enough to list here. Plus, there is no one better suited to talk about it than us.*
{{< /note >}}
